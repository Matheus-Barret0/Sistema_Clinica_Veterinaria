...
<body>
    <div class="container">
        <?php
            ...
            $sql = "SELECT nomeCompleto, user_name, tipoPessoa FROM user LIMIT $offset, $resultadosPorPagina";
            $stmt = $conn->query($sql);
            ...
            print "<input class='form-control' type='text' placeholder='Procure pelo nome'>";
